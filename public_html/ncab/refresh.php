...
error_log('Start refresh at' . date('d.m.Y H:i:s') . "\r\n", 3, $logFile);
...
error_log('Generate ' . $__cfg['site.dir'] . '/ncab/ftp/Export_meters.ZIP' . "\r\n", 3, $logFile);
...
if (file_exists($__cfg['site.dir'] . '/ncab/ftp/IMPORT.ZIP')) {
    ...
    error_log('Inport ' . $__cfg['site.dir'] . '/ncab/ftp/IMPORT.ZIP' . "\r\n", 3, $logFile);
