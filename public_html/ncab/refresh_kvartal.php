...
error_log('Start refresh Kvartal at ' . date('d.m.Y H:i:s'), 3, $logFile);
...
error_log('Generate Kvartal ' . $__cfg['site.dir'] . '/ncab/ftp/Export_meters.ZIP', 3, $logFile);
...
if (file_exists($__cfg['site.dir'] . '/' . $__cfg['ncab.path'] . '/ftp/IMPORT.ZIP')) {
    ...
    error_log('Inport Kvartal ' . $__cfg['site.dir'] . '/ncab/ftp/IMPORT.ZIP', 3, $logFile);
    unlink($__cfg['site.dir'] . '/' . $__cfg['ncab.path'] . '/ftp/IMPORT.ZIP');
}

error_log('End refresh Kvartal at' . date('d.m.Y H:i:s'), 3, $logFile);
exit;