                                ...
                                <table>
                                    <tr>
                                        <td style="width: 464px;">
                                            <div>
                                                <div style="color: #0e426b; padding: 10px 0 0 60px; font-size: 14pt;">Контакты</div>
                                                <div style="color: #2191d0; font-size: 24pt; padding: 50px 0 0 60px;"><span style="color: #5f5e5d; font-size: 12pt; vertical-align: text-top;">8 (3842)</span>
                                                   75-62-46</div>
                                            </div>
                                        </td>
                            ...
                            <td class="nizfon">
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding: 0; text-align: right; vertical-align: middle; padding-right: 40px;">
