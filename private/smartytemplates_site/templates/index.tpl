    ...
    <tr>
        <td style="width: 60%; padding: 0px;"> {* 404px; *}
            <div style="padding: 20px;">
                ...
                {if $domen=='xn----7sbmzidj6b1b.xn--p1ai' || $domen=='xn----8sbifcsdibgfzb7bru.xn--p1ai' || $domen=='xn----htbdepbihnfb8cyg.xn--p1ai'}
                {$conpage_first.content}

                {elseif $domen=='xn----2-fddihw2arbyke.xn--p1ai' || $domen=='xn----btbaoazc2alocedz3kqc.xn--p1ai'}
