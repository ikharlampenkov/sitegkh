<?php /* Smarty version Smarty-3.0.7, created on 2012-05-29 13:20:02
         compiled from "/home/dnevnik/private/smartytemplates_site/templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20555217464fc45c82565299-66176719%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20555217464fc45c82565299-66176719',
  'function' => 
  array (
  ),
    ...
    <tr>
        <td style="width: 60%; padding: 0px;"> 
            <div style="padding: 20px;">
                ...
                <?php if ($_smarty_tpl->getVariable('domen')->value=='xn----7sbmzidj6b1b.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='xn----8sbifcsdibgfzb7bru.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='xn----htbdepbihnfb8cyg.xn--p1ai'){?>
                <?php echo $_smarty_tpl->getVariable('conpage_first')->value['content'];?>


                <?php }elseif($_smarty_tpl->getVariable('domen')->value=='xn----2-fddihw2arbyke.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='xn----btbaoazc2alocedz3kqc.xn--p1ai'){?>
