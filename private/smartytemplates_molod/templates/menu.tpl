<div class="panel">
    ...
    <ul class="sub">
        ...
        {if $spage=='house'}
            ...
            <li class="{if $category=='reports'}active{else}noactive{/if}"><a title="Отчет по капитальном ремонту" href="?page=content_page&title=fin_ot._2011">Финансовый отчет за 2011 г.</a></li>
        {/if}
        {if $spage=='reports'}
