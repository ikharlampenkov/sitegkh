...
<div style="text-align:center">
    <ul class="sub">
        ...
        {if $spage=='service'}
            ...
            <li class="{if $conpage_title=='plotnitskie_rab'}active{else}noactive{/if}"><a title="Плотницкие, столярные, стекольные" href="?page=content_page&title=plotnitskie_rab&spage=service">Плотницкие, столярные, стекольные</a></li>
            <li class="{if $conpage_title=='pechnie_rab'}active{else}noactive{/if}"><a title="Печные" href="?page=content_page&title=pechnie_rab&spage=service">Печные</a></li>
            <li class="{if $conpage_title=='otdelochnie_rab'}active{else}noactive{/if}"><a title="Отделочные" href="?page=content_page&title=otdelochnie_rab&spage=service">Отделочные</a></li>
            <li class="{if $conpage_title=='service_other'}active{else}noactive{/if}"><a title="Прочие" href="?page=content_page&title=service_other&spage=service">Прочие</a></li>
        ...
        {if $spage=='reports'}
            ...
            <li class="{if $conpage_title=='reports_kap_remont'}active{else}noactive{/if}"><a title="Капитальный ремонт" href="?page=content_page&title=reports_kap_remont&spage=reports">Капитальный ремонт</a></li>
        {/if}
    </ul>
</div>
