...
<div style="text-align:center">
    <ul class="sub">
        ...
        {if $spage=='service'}
            ...
            <li class="{if $conpage_title=='plotnitskie_rab'}active{else}noactive{/if}"><a title="Плотницкие" href="?page=content_page&title=plotnitskie_rab&spage=service">Плотницкие</a></li>
