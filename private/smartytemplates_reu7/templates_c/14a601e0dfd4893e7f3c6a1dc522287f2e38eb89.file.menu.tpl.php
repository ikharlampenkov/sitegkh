<?php /* Smarty version Smarty-3.0.7, created on 2011-10-19 07:27:12
         compiled from "/home/dnevnik/private/smartytemplates_reu7/templates/admin/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:915652464e9e1960334b61-44250669%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '14a601e0dfd4893e7f3c6a1dc522287f2e38eb89' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_reu7/templates/admin/menu.tpl',
      1 => 1318963673,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '915652464e9e1960334b61-44250669',
  'function' => 
  array (
  ),
...
<div style="text-align:center">
    <ul class="sub">
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='service'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='eltechrab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Электротехнические" href="?page=content_page&action=edit&id=eltechrab&spage=service">Электротехнические</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='santechrab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Сантехнические" href="?page=content_page&action=edit&id=santechrab&spage=service">Сантехнические</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='plotnitskie_rab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Плотницкие" href="?page=content_page&action=edit&id=plotnitskie_rab&spage=service">Плотницкие</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='pechnie_rab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Печные" href="?page=content_page&action=edit&id=pechnie_rab&spage=service">Печные</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='otdelochnie_rab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Отделочные" href="?page=content_page&action=edit&id=otdelochnie_rab&spage=service">Отделочные</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='service_other'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Прочие" href="?page=content_page&action=edit&id=service_other&spage=service">Прочие</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='rates'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='distributor'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Поставщики" href="?page=content_page&action=edit&id=distributor&spage=rates">Поставщики</a></li>
        <?php }?>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='reports_kap_remont'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Капитальный ремонт" href="?page=content_page&action=edit&id=reports_kap_remont&spage=reports">Капитальный ремонт</a></li>
        <?php }?>
    </ul>
</div>
