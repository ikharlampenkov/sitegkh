<div class="panel">
    ...
    <ul class="sub">
        ...
        {if $spage=='house'}
            ...
            <li class="{if $category=='plan'}active{else}noactive{/if}"><a title="Информация для жильцов" href="?page=content_page&title=plan_prov_rabot&spage=house">Информация для жильцов</a></li>
        {/if}
        {if $spage=='reports'}
