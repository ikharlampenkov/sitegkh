<div class="panel">
    ...
    <ul class="sub">
        ...
        {/if}
        {if $spage=='service'}
            <li class="{if $conpage_title=='eltechrab'}active{else}noactive{/if}"><a title="Прайс лист платных услуг" href="?page=content_page&title=eltechrab&spage=service">Прайс лист платных услуг</a></li>
        ...
        {if $spage=='house'}
            ...
            <li class="{if $category=='plan'}active{else}noactive{/if}"><a title="План проводимых работ" href="?page=content_page&title=perechen_domov">План проводимых работ</a></li>
            {*<li class="{if $category=='reports'}active{else}noactive{/if}"><a title="Отчет по капитальном ремонту" href="?page=content_page&title=perechen_domov">Отчет по капитальном ремонту</a></li>*}
        {/if}
        {if $spage=='reports'}
