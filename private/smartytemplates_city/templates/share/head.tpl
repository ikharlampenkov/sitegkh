                                        ...
                                        <td class="imgc">
                                            ...
                                            <table style="width: 368px; height: 346px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 340px; height: 261px; padding: 0px; vertical-align: middle;"><img src="/i/yk_gorod.jpg" alt="{$title}" /></td>
                                        ...
                                        <td class="imgr">
                                            <div class="imgr_block">
                                                ...
                                                <div class="imgr_link_block">
                                                    ...
                                                    <span class="imgr_title">{$phones_mp.title}</span><br/>
                                                    <span class="imgr_text">({$phones_mp.phone_code}) {$phones_mp.phone}</span><br/>
                                                    <span class="imgr_text">{$phones_mp.comment}</span><br/>
                                                    {/foreach}    
