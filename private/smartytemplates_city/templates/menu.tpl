<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="{if $spage=='house'}active{else}noactive{/if}"><a id="tma" title="Ваш дом" href="?page=content_page&title=doma">Ваш дом</a></li>
    ...
    <ul class="sub">
        {if $spage=='main'}
            ...
            <li class="{if $page=='faq' && isset($is_situation) && $is_situation==1}active{else}noactive{/if}"><a title="Жизненные ситуации" href="?page=content_page&title=helpful_information">Жизненные ситуации</a></li>
        ...
        {/if}
        {if $spage=='house'}
            <li class="{if $category=='all'}active{else}noactive{/if}"><a title="Обслуживаемые дома" href="?page=content_page&title=doma">Обслуживаемые дома</a></li>
        ...
        {/if}
        {if $spage=='reports'}
            <li class="{if $conpage_title=='financial_statements'}active{else}noactive{/if}"><a title="Бухгалтерский баланс 2012" href="?page=content_page&title=balans2012">Бухгалтерский баланс 2012</a></li>
            <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Отчет о финансовых результатах" href="?page=content_page&title=finance2012">Отчет о прибылях и убытках</a></li>
        {/if}
    </ul>
