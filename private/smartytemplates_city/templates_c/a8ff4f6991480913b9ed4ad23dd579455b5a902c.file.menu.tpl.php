<?php /* Smarty version Smarty-3.0.7, created on 2013-04-24 16:07:09
         compiled from "/home/dnevnik/private/smartytemplates_city/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11930403765177a0bd319313-91656846%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a8ff4f6991480913b9ed4ad23dd579455b5a902c' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_city/templates/menu.tpl',
      1 => 1366794423,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11930403765177a0bd319313-91656846',
  'function' => 
  array (
  ),
...
<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="<?php if ($_smarty_tpl->getVariable('spage')->value=='house'){?>active<?php }else{ ?>noactive<?php }?>"><a id="tma" title="Ваш дом" href="?page=content_page&title=doma">Ваш дом</a></li>
    ...
    <ul class="sub">
        <?php if ($_smarty_tpl->getVariable('spage')->value=='main'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('page')->value=='faq'&&isset($_smarty_tpl->getVariable('is_situation',null,true,false)->value)&&$_smarty_tpl->getVariable('is_situation')->value==1){?>active<?php }else{ ?>noactive<?php }?>"><a title="Жизненные ситуации" href="?page=content_page&title=helpful_information">Жизненные ситуации</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='house'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('category')->value=='all'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Обслуживаемые дома" href="?page=content_page&title=doma">Обслуживаемые дома</a></li>
        <?php }?>
        <?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='financial_statements'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Бухгалтерский баланс 2012" href="?page=content_page&title=balans2012">Бухгалтерский баланс 2012</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='income'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Отчет о финансовых результатах" href="?page=content_page&title=finance2012">Отчет о прибылях и убытках</a></li>
        <?php }?>
    </ul>


<script type="text/javascript">
                                var submenus = [ { id:"tmM",subs:[ { "t":"Раскрытие информации","u":"?page=content_page&title=disclosure_of_information" } , { "t":"Жизненные ситуации","u":"?page=content_page&title=helpful_information" } , { "t":"Важная информация","u":"?page=content_page&title=important_information" } ] } ,
    ...
    { id:"tma",subs:[ { "t":"Обслуживаемые дома","u":"?page=content_page&title=doma" }] } ,
    { id:"tmO",subs:[ { "t":"Бухгалтерскй баланс 2012","u":"?page=content_page&title=balans2012" } , { "t":"Отчет о финансовых результатах","u":"?page=content_page&title=finance2012" } ] } ];
</script>