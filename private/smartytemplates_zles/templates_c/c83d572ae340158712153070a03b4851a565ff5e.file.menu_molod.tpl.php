<?php /* Smarty version Smarty-3.0.7, created on 2011-12-16 10:12:29
         compiled from "/home/dnevnik/private/smartytemplates_site/templates/menu_molod.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10591251384eeab71d1d2fe7-45432113%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c83d572ae340158712153070a03b4851a565ff5e' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_site/templates/menu_molod.tpl',
      1 => 1324005137,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10591251384eeab71d1d2fe7-45432113',
  'function' => 
  array (
  ),
...
<div class="panel">
    ...
    <ul class="sub">
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='service'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='eltechrab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Электротехнические работы" href="?page=content_page&title=eltechrab&spage=service">Электротехнические</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='santechrab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Сантехнические работы" href="?page=content_page&title=santechrab&spage=service">Сантехнические</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='keep_the_house'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Плотничные, столярные и стекольные работы" href="?page=content_page&title=prochie_rab&spage=service">Плотничные, столярные и стекольные</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='house'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('category')->value=='plan'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Информация для жильцов" href="?page=content_page&title=plan_prov_rabot&spage=house">Информация для жильцов</a></li>
        <?php }?>
...
<script type="text/javascript">
    ...
    { id:"tma",subs:[ { "t":"Обслуживаемые дома","u":"?page=house&category=all&spage=house" } , { "t":"Информация для жильцов","u":"?page=content_page&title=plan_prov_rabot&spage=house" } ] } ,
