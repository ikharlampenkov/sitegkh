<?php /* Smarty version Smarty-3.0.7, created on 2012-02-22 14:46:44
         compiled from "/home/dnevnik/private/smartytemplates_gilservice/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9060681584f449d6414c097-92186011%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d6ac0479e817fec116613b8170b41ec0c95920a' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_gilservice/templates/menu.tpl',
      1 => 1329896789,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9060681584f449d6414c097-92186011',
  'function' => 
  array (
  ),
...
<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="<?php if ($_smarty_tpl->getVariable('spage')->value=='house'){?>active<?php }else{ ?>noactive<?php }?>"><a id="tma" title="Ваш дом" href="?page=content_page&title=vashdom">Ваш дом</a></li>
                    <li class="<?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>active<?php }else{ ?>noactive<?php }?>"><a id="tmO" title="Отчеты" href="?page=content_page&title=vashdom">Отчеты</a></li>
                </ul>
            </td>
    ...
    <ul class="sub">
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='service'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='keep_the_house'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Прочие" href="?page=content_page&title=other_service">Прочие</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='house'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('category')->value=='all'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Обслуживаемые дома" href="?page=content_page&title=vashdom">Обслуживаемые дома</a></li>
        <?php }?>
        <?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='financial_statements'){?>active<?php }else{ ?>noactive<?php }?>"><a title="План расходов" href="?page=content_page&title=vashdom">План расходов</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='income'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Отчёт по расходам" href="?page=content_page&title=vashdom">Отчёт по расходам</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='income'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Отчёт по затратам" href="?page=content_page&title=vashdom">Отчёт по затратам</a></li>
        <?php }?>
    </ul>
...
<script type="text/javascript">
    ...
    { id:"tmS",subs:[ { "t":"Электротехнические работы","u":"?page=content_page&title=eltechrab&spage=service" } , { "t":"Сантехнические работы","u":"?page=content_page&title=santechrab&spage=service" } , { "t":"Прочие","u":"?page=content_page&title=other_service" } , { "t":"Где оплатить?","u":"?page=content_page&title=where_to_pay&spage=service" } ] } ,
    ...
    { id:"tma",subs:[ { "t":"Обслуживаемые дома","u":"?page=content_page&title=vashdom" } ] } ,
    { id:"tmO",subs:[ { "t":"План расходов","u":"?page=content_page&title=vashdom" } , { "t":"Отчёт по расходам","u":"?page=content_page&title=vashdom" }  , { "t":"Отчёт по затратам","u":"?page=content_page&title=vashdom" }] } ];
</script>