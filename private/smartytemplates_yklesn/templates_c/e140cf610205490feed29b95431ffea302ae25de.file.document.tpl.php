<?php /* Smarty version Smarty-3.0.7, created on 2013-06-25 10:41:51
         compiled from "/home/dnevnik/private/smartytemplates_yklesn/templates/admin/document.tpl" */ ?>
<?php /*%%SmartyHeaderCode:165967724651c9117f363da2-13025136%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e140cf610205490feed29b95431ffea302ae25de' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_yklesn/templates/admin/document.tpl',
      1 => 1338468162,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '165967724651c9117f363da2-13025136',
  'function' => 
  array (
  ),
...
<?php if ($_smarty_tpl->getVariable('action')->value=="edit"){?>&id=<?php echo $_smarty_tpl->getVariable('document')->value['id'];?>
...
" /></td>
        ...
        <tr class="pem">
            ...
            <td><textarea name="data[shorttext]"><?php echo $_smarty_tpl->getVariable('document')->value['short_text'];?>
</textarea></td>
        </tr class="pem">
        <tr class="pem">
...
" <?php if (isset($_smarty_tpl->getVariable('document',null,true,false)->value['parent_id'])&&$_smarty_tpl->getVariable('document')->value['parent_id']==$_smarty_tpl->tpl_vars['folder']->value['id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['folder']->value['title'];?>
    ...
    <input type="hidden" name="data[shorttext]" value="" />
