<?php /* Smarty version Smarty-3.0.7, created on 2013-03-14 22:30:08
         compiled from "/home/dnevnik/private/smartytemplates_gilishnik/templates/admin/faq.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20167320185141fb1021e752-95045638%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a9fb6d5b04b6aa7d6ab35b3ef7e85d2dd5b8dcbb' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_gilishnik/templates/admin/faq.tpl',
      1 => 1363278605,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20167320185141fb1021e752-95045638',
  'function' => 
  array (
  ),
...
" <?php if (isset($_smarty_tpl->getVariable('faq',null,true,false)->value['parrent_id'])&&$_smarty_tpl->getVariable('faq')->value['parrent_id']==$_smarty_tpl->tpl_vars['folder']->value['id']){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['folder']->value['question'];?>
</option>
                    <?php }} ?>
                </select></td>
        </tr>
        ...
        <tr class="pem">
            <td>Отображать</td>
            <td><input type="checkbox" name="data[is_moderate]" <?php if (isset($_smarty_tpl->getVariable('faq',null,true,false)->value['is_moderate'])&&$_smarty_tpl->getVariable('faq')->value['is_moderate']){?>checked="checked"<?php }?> style="width: 14px;" /></td>
        </tr>
    </table>
...
<?php }?></td>
	<td class="pem"><?php echo smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['faq']->value['answer']),200);?>
</td>
