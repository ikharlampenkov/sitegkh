...
<?php /*%%SmartyHeaderCode:8893892254ed33db2983067-26798563%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '8893892254ed33db2983067-26798563',
  'function' => 
  array (
  ),
    ...
    <tr>
        <td style="width: 60%; padding: 0px;"> 
            <div style="padding: 20px;">
                ...
                <?php if ($_smarty_tpl->getVariable('domen')->value=='xn----htbdepbihnfb8cyg.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='xn----2-fddihw2arbyke.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='xn----btbaoazc2alocedz3kqc.xn--p1ai'){?>
