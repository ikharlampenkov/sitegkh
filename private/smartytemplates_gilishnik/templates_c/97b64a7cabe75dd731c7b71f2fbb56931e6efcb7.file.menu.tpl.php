<?php /* Smarty version Smarty-3.0.7, created on 2013-04-22 22:14:11
         compiled from "/home/dnevnik/private/smartytemplates_gilishnik/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:268914118517553c399c323-55804383%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97b64a7cabe75dd731c7b71f2fbb56931e6efcb7' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_gilishnik/templates/menu.tpl',
      1 => 1366643645,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '268914118517553c399c323-55804383',
  'function' => 
  array (
  ),
...
<div class="panel">
    ...
    <ul class="sub">
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='about'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('page')->value=='license'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Свидетельство" href="?page=content_page&title=dostijenia&spage=about">Достижения</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='service'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='keep_the_house'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Плотнические и столярные" href="?page=content_page&title=keep_the_house&spage=service">Плотнические и столярные</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='financial_statements'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Бухгалтерская отчетность" href="?page=content_page&title=financial_statements2012&spage=reports">Бухгалтерская отчетность</a></li>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='income'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Отчет о прибылях и убытках" href="?page=content_page&title=income2012&spage=reports">Отчет о прибылях и убытках</a></li>
        <?php }?>
    </ul>
...
<script type="text/javascript">
    ...
    { id:"tmC",subs:[ { "t":"Общая информация","u":"?page=content_page&title=general_information&spage=about" } , { "t":"Достижения","u":"?page=content_page&title=dostijenia&spage=about" } , { "t":"Коллектив","u":"?page=content_page&title=leaders&spage=about" } , { "t":"Паспортный стол","u":"?page=content_page&title=passport_office&spage=about" } , { "t":"Вакансии","u":"?page=vacancy&spage=about" } , { "t":"Контакты","u":"?page=content_page&title=contact&spage=about" } ] } ,
    { id:"tmS",subs:[ { "t":"Электротехнические","u":"?page=content_page&title=eltechrab&spage=service" } , { "t":"Сантехнические","u":"?page=content_page&title=santechrab&spage=service" } , { "t":"Плотнические и столярные","u":"?page=content_page&title=keep_the_house&spage=service" } , { "t":"Где оплатить?","u":"?page=content_page&title=where_to_pay&spage=service" } ] } ,
    ...
    { id:"tmO",subs:[ { "t":"Бухгалтерская отчетность","u":"?page=content_page&title=financial_statements2012&spage=reports" } , { "t":"Отчет о прибылях и убытка","u":"?page=content_page&title=income2012&spage=reports" } ] } ];
</script>