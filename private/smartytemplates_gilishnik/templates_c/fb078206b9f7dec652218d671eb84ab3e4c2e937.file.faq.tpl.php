<?php /* Smarty version Smarty-3.0.7, created on 2013-03-14 22:15:22
         compiled from "/home/dnevnik/private/smartytemplates_gilishnik/templates/faq.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5565915575141f79aa10c27-97071016%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb078206b9f7dec652218d671eb84ab3e4c2e937' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_gilishnik/templates/faq.tpl',
      1 => 1363277579,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5565915575141f79aa10c27-97071016',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->getVariable('path_to_faq')->value[$_smarty_tpl->getVariable('smarty')->value['section']['path_doc']['index']]['question'];?>
    ...
    <?php  $_smarty_tpl->tpl_vars['faql'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('faq_list')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['faql']->key => $_smarty_tpl->tpl_vars['faql']->value){
?>
        <?php if ($_smarty_tpl->tpl_vars['faql']->value['is_folder']){?>
            <tr>
                <td class="pem"><img src="/img/folder.png"/> <a href="?page=<?php echo $_smarty_tpl->getVariable('page')->value;?>
&root=<?php echo $_smarty_tpl->tpl_vars['faql']->value['id'];?>
<?php if ($_smarty_tpl->tpl_vars['faql']->value['is_situation']==1){?>&is_situation=1<?php }?>"><?php echo $_smarty_tpl->tpl_vars['faql']->value['question'];?>
</a></td>
            </tr>
            <?php }else{ ?>
            <tr>
                <td class="pem"><a href="?page=<?php echo $_smarty_tpl->getVariable('page')->value;?>
&action=view&id=<?php echo $_smarty_tpl->tpl_vars['faql']->value['id'];?>
<?php if ($_smarty_tpl->tpl_vars['faql']->value['is_situation']==1){?>&is_situation=1<?php }?>"><?php echo $_smarty_tpl->tpl_vars['faql']->value['question'];?>
</a>
                </td>
            </tr>
