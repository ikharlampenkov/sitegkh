<div class="panel">
    ...
    <ul class="sub">
        ...
        {if $spage=='about'}
            ...
            <li class="{if $page=='license'}active{else}noactive{/if}"><a title="Свидетельство" href="?page=content_page&title=dostijenia&spage=about">Достижения</a></li>
        ...
        {/if}
        {if $spage=='service'}
            <li class="{if $conpage_title=='eltechrab'}active{else}noactive{/if}"><a title="Электротехнические" href="?page=content_page&title=eltechrab&spage=service">Электротехнические</a></li>
            <li class="{if $conpage_title=='santechrab'}active{else}noactive{/if}"><a title="Сантехнические" href="?page=content_page&title=santechrab&spage=service">Сантехнические</a></li>
            <li class="{if $conpage_title=='keep_the_house'}active{else}noactive{/if}"><a title="Плотнические и столярные" href="?page=content_page&title=keep_the_house&spage=service">Плотнические и столярные</a></li>
        ...
        {/if}
        {if $spage=='reports'}
            <li class="{if $conpage_title=='financial_statements'}active{else}noactive{/if}"><a title="Бухгалтерская отчетность" href="?page=content_page&title=financial_statements2012&spage=reports">Бухгалтерская отчетность</a></li>
            <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Отчет о прибылях и убытках" href="?page=content_page&title=income2012&spage=reports">Отчет о прибылях и убытках</a></li>
        {/if}
    </ul>
