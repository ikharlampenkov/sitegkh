...
<ul class="sub">
    ...
    {if $spage=='main'}
        <li class="{if $conpage_title=='main'}active{else}noactive{/if}"><a title="Раскрытие информации в сфере МКД" href="?page=content_page&title=disclosure_of_information&spage=main">Раскрытие информации в сфере МКД</a></li>
    {/if}


    {if $spage=='about'}
        <li class="{if $conpage_title=='about'}active{else}noactive{/if}"><a title="О нас" href="?page=content_page&title=about&spage=about">О нас</a></li>
        <li class="{if $conpage_title=='team'}active{else}noactive{/if}"><a title="Коллектив" href="?page=content_page&title=team&spage=about">Коллектив</a></li>
        <li class="{if $conpage_title=='mode'}active{else}noactive{/if}"><a title="Режим работы" href="?page=content_page&title=mode&spage=about">Режим работы</a></li>
        ...
        <li class="{if $conpage_title=='foto'}active{else}noactive{/if}"><a title="Фотогалерея" href="?page=content_page&title=foto&spage=about">Фотогалерея</a></li>
    {/if}

    {if $spage=='service'}
        <li class="{if $conpage_title=='tarif'}active{else}noactive{/if}"><a title="Действующие тарифы" href="?page=content_page&title=tarif&spage=service">Действующие тарифы</a></li>
        <li class="{if $conpage_title=='distributor'}active{else}noactive{/if}"><a title="Поставщики" href="?page=content_page&title=distributor&spage=service">Поставщики</a></li>
        <li class="{if $conpage_title=='normativ'}active{else}noactive{/if}"><a title="Нормативы" href="?page=content_page&title=normativ&spage=service">Нормативы</a></li>
        <li class="{if $conpage_title=='paid'}active{else}noactive{/if}"><a title="Платные услуги" href="?page=content_page&title=paid&spage=service">Платные услуги</a></li>
    {/if}

    {if $spage=='residents'}
        <li class="{if $conpage_title=='helpful_information'}active{else}noactive{/if}"><a title="Полезная информация" href="?page=content_page&title=helpful_information&spage=residents">Полезная информация</a></li>
    {/if}
    ...
    {if $spage=='documentation'}
        <li class="{if $conpage_title=='documentation'}active{else}noactive{/if}"><a title="Документы" href="?page=content_page&title=documentation&spage=documentation">Документы</a></li>
    {/if}
</ul>
