...
<form action="?page={$page}&action={$action}{if $action=="edit"}&id={$document.id}{/if}" method="post" enctype="multipart/form-data">
    <table cellpadding="5" border="0" style="font-size:14px;">
        ...
        <tr class="pem">
            ...
            <td><textarea name="data[shorttext]">{$document.short_text}</textarea></td>
        </tr class="pem">
        <tr class="pem">
