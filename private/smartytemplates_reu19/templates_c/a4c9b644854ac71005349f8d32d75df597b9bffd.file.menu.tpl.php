<?php /* Smarty version Smarty-3.0.7, created on 2012-04-03 15:08:42
         compiled from "/home/dnevnik/private/smartytemplates_reu19/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18372842024f7aa1fa61fae6-10694653%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a4c9b644854ac71005349f8d32d75df597b9bffd' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_reu19/templates/menu.tpl',
      1 => 1333436916,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18372842024f7aa1fa61fae6-10694653',
  'function' => 
  array (
  ),
...
<div class="panel">
    ...
    <ul class="sub">
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='about'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('page')->value=='license'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Свидетельство" href="?page=content_page&title=foto">Фотоотчёт</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='service'){?>
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='santechrab'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Платные услуги" href="?page=content_page&title=santechrab&spage=service">Платные услуги</a></li>
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='income'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Отчет о капитальном ремонте" href="?page=content_page&title=kap_remont">Отчет о капитальном ремонте</a></li>
        <?php }?>
    </ul>
...
<script type="text/javascript">
    ...
    { id:"tmO",subs:[ { "t":"Бухгалтерская отчетность","u":"?page=content_page&title=financial_statements&spage=reports" } , { "t":"Отчет о прибылях и убытках","u":"?page=content_page&title=income&spage=reports" } , { "t":"Отчет о капитальном ремонте","u":"?page=content_page&title=kap_remont" }] } ];
</script>