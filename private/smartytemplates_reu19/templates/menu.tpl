<div class="panel">
    ...
    <ul class="sub">
        ...
        {if $spage=='reports'}
            ...
            <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Отчет о капитальном ремонте" href="?page=content_page&title=kap_remont">Отчет о капитальном ремонте</a></li>
        {/if}
    </ul>
