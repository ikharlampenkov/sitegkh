...
<ul class="sub">
    ...
    {if $spage=='about'}
        ...
        <li class="{if $page=='license'}active{else}noactive{/if}"><a title="Свидетельство" href="?page=content_page&title=foto">Фотоотчёт</a></li>
    ...
    {if $spage=='service'}
        ...
        <li class="{if $conpage_title=='santechrab'}active{else}noactive{/if}"><a title="Платные услуги" href="?page=content_page&title=santechrab&spage=service">Платные услуги</a></li>
    ...
    {if $spage=='house'}
        ...
        {*<li class="{if $category=='reports'}active{else}noactive{/if}"><a title="Отчет по капремонту" href="?page=house&category=reports&spage=house">Отчет по капремонту</a></li>*}
    {/if}
    {if $spage=='reports'}
        <li class="{if $conpage_title=='financial_statements'}active{else}noactive{/if}"><a title="Бухгалтерская отчетность" href="?page=content_page&title=financial_statements2013">Бухгалтерская отчетность</a></li>
        <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Отчёт о выполненных обязательствах" href="?page=content_page&title=otchetovp2013">Отчёт о выполненных обязательствах</a></li>
        <li class="{if $conpage_title=='kap_remont'}active{else}noactive{/if}"><a title="Отчет о капремонте" href="?page=content_page&title=kap_remont">Отчет о капремонте</a></li>
    {/if}
</ul>
...
<script type="text/javascript">
    var submenus = [
        { id: "tmM", subs: [ { "t": "Раскрытие информации", "u": "?page=content_page&title=disclosure_of_information" } ,  { "t": "Жизненные ситуации", "u": "?page=faq&is_situation=1" } ,  { "t": "Важная информация", "u": "?page=content_page&title=important_information" } ] } ,
        { id: "tmC", subs: [ { "t": "Общая информация", "u": "?page=content_page&title=general_information&spage=about" } ,  { "t": "Фотоотчёт", "u": "?page=content_page&title=foto" } ,  { "t": "Коллектив", "u": "?page=content_page&title=leaders&spage=about" } ,  { "t": "Паспортный стол", "u": "?page=content_page&title=passport_office&spage=about" } ,  { "t": "Вакансии", "u": "?page=vacancy&spage=about" } ,  { "t": "Контакты", "u": "?page=content_page&title=contact&spage=about"}]},
        { id: "tmS", subs: [ { "t": "Платные услуги", "u": "?page=content_page&title=santechrab&spage=service" } ,  { "t": "Содержание дома", "u": "?page=content_page&title=keep_the_house&spage=service" } ,  { "t": "Где оплатить?", "u": "?page=content_page&title=where_to_pay&spage=service"}]},
        ...
        { id: "tmO", subs: [ { "t": "Бухгалтерская отчетность", "u": "?page=content_page&title=financial_statements2013" } ,  { "t": "Отчёт о выполненных обязательствах", "u": "?page=content_page&title=otchetovp2013" } ,  { "t": "Отчет о капремонте", "u": "?page=content_page&title=kap_remont"}]}];
</script>