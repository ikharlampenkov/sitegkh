...
<h4>Дом </h4>
    ...
    <a href="{$siteurl}temp_files/{$house.file_repair_plan}" target="_blank">План работ по содержанию и ремонту</a><br/>
    <br/>
    {/if}
                    ...
                    {foreach from=$street.houses item=house}
                        ...
                        *}
                            ...
                            {if $category=='all'}
                                <td class="pim" align="center">
                                    {if !empty($house.file_repair_plan)}
                                        <a href="{$siteurl}temp_files/{$house.file_repair_plan}"
