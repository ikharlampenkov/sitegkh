<?php /* Smarty version Smarty-3.0.7, created on 2013-05-30 12:56:59
         compiled from "/home/dnevnik/private/smartytemplates_kvartal/templates/menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:88348882751a6ea2b76fb34-08283571%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3018e28df947beac352a96a205046b9ffccc5dd' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_kvartal/templates/menu.tpl',
      1 => 1369893413,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '88348882751a6ea2b76fb34-08283571',
  'function' => 
  array (
  ),
...
<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="<?php if ($_smarty_tpl->getVariable('spage')->value=='about'){?>active<?php }else{ ?>noactive<?php }?>"><a id="tmC" title="О нас">О нас</a></li>
                    ...
                    <li class="<?php if ($_smarty_tpl->getVariable('spage')->value=='rates'){?>active<?php }else{ ?>noactive<?php }?>"><a id="tmL" title="Тарифы">Тарифы</a></li>
                    ...
                    <li class="<?php if ($_smarty_tpl->getVariable('spage')->value=='reports'){?>active<?php }else{ ?>noactive<?php }?>"><a id="tmO" title="Отчеты">Отчеты</a></li>
                </ul>
            </td>
    ...
    <ul class="sub">
        ...
        <?php if ($_smarty_tpl->getVariable('spage')->value=='rates'){?>
            ...
            <li class="<?php if ($_smarty_tpl->getVariable('conpage_title')->value=='distributor'){?>active<?php }else{ ?>noactive<?php }?>"><a title="Поставщики" href="?page=content_page&title=komuslugi&spage=rates">Поставщики</a></li>
...
<script type="text/javascript">
    ...
    { id:"tmL",subs:[ { "t":"Тарифы","u":"?page=content_page&title=gkh&spage=rates" } , { "t":"Поставщики","u":"?page=content_page&title=komuslugi&spage=rates" } , { "t":"Где оплатить?","u":"?page=content_page&title=where_to_pay&spage=rates" } ] } ,
    ...
    { id:"tma",subs:[ { "t":"Обслуживаемые дома","u":"?page=content_page&title=perechen_domov" } ] },
    { id:"tmO",subs:[ { "t":"Бухгалтерская отчетность","u":"?page=content_page&title=financial_statements&spage=reports" } ] } ];
</script>