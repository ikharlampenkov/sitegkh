<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="{if $spage=='about'}active{else}noactive{/if}"><a id="tmC" title="О нас">О нас</a></li>
                    <li class="{if $spage=='service'}active{else}noactive{/if}"><a id="tmS" title="Услуги">Услуги</a></li>
                    <li class="{if $spage=='rates'}active{else}noactive{/if}"><a id="tmL" title="Тарифы">Тарифы</a></li>
                    ...
                    <li class="{if $spage=='reports'}active{else}noactive{/if}"><a id="tmO" title="Отчеты">Отчеты</a></li>
                </ul>
            </td>
    ...
    <ul class="sub">
        ...
        {if $spage=='rates'}
            ...
            <li class="{if $conpage_title=='distributor'}active{else}noactive{/if}"><a title="Поставщики" href="?page=content_page&title=komuslugi&spage=rates">Поставщики</a></li>
