<?php /* Smarty version Smarty-3.0.7, created on 2012-08-29 01:48:27
         compiled from "/home/dnevnik/private/smartytemplates_leningrad/templates/share/head.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1016672495503d127af15d52-54208656%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d7bbb53c429cd24483274994b07f44f1c534db2' => 
    array (
      0 => '/home/dnevnik/private/smartytemplates_leningrad/templates/share/head.tpl',
      1 => 1346164153,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1016672495503d127af15d52-54208656',
  'function' => 
  array (
  ),
...
<?php }?>
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <?php if ($_smarty_tpl->getVariable('razdel_type')->value=='admin'){?>
                                            <?php if ($_smarty_tpl->getVariable('domen')->value=='xn----htbdepbihnfb8cyg.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='xn----btbaoazc2alocedz3kqc.xn--p1ai'){?>
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                                            <?php }elseif($_smarty_tpl->getVariable('domen')->value=='xn----2-fddihw2arbyke.xn--p1ai'){?>
                                                <?php $_template = new Smarty_Internal_Template("menu_domo.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
                                            <?php }else{ ?>
                                        ...
                                        <td class="imgc">
                                            ...
                                            <table style="width: 368px; height: 346px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 340px; height: 261px; padding: 0px; vertical-align: middle;"><?php if ($_smarty_tpl->getVariable('domen')->value=='xn--21-kmcm3c.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='www.xn--21-kmcm3c.xn--p1ai'){?><img src="/i/reu_21.jpg" alt="<?php echo $_smarty_tpl->getVariable('title')->value;?>
" />
													                                                       <?php }elseif($_smarty_tpl->getVariable('domen')->value=='xn----htbdepbihnfb8cyg.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='www.xn----htbdepbihnfb8cyg.xn--p1ai'){?><img src="/i/yk_molod.png" alt="<?php echo $_smarty_tpl->getVariable('title')->value;?>
" />
													                                                       <?php }elseif($_smarty_tpl->getVariable('domen')->value=='xn--19-kmcm3c.xn--p1ai'||$_smarty_tpl->getVariable('domen')->value=='www.xn--19-kmcm3c.xn--p1ai'){?><img src="/i/reu_19.jpg" alt="<?php echo $_smarty_tpl->getVariable('title')->value;?>
" />
																										   <?php }?></td>
