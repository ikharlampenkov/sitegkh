                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        {if $razdel_type=='admin'}
                                            {if $domen=='xn----htbdepbihnfb8cyg.xn--p1ai' || $domen=='xn----btbaoazc2alocedz3kqc.xn--p1ai'}
                                                {include file="menu_molod.tpl"}
                                            {elseif $domen=='xn----2-fddihw2arbyke.xn--p1ai'}
                                                {include file="menu_domo.tpl"}
                                            {else}
                                        ...
                                        <td class="imgc">
                                            ...
                                            <table style="width: 368px; height: 346px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 340px; height: 261px; padding: 0px; vertical-align: middle;"><img src="/i/gilservice.jpg" alt="{$title}" /></td>
