<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="{if $spage=='house'}active{else}noactive{/if}"><a id="tma" title="Ваш дом" href="?page=content_page&title=vashdom">Ваш дом</a></li>
                    <li class="{if $spage=='reports'}active{else}noactive{/if}"><a id="tmO" title="Отчеты" href="?page=content_page&title=vashdom">Отчеты</a></li>
                </ul>
            </td>
    ...
    <ul class="sub">
        ...
        {if $spage=='service'}
            ...
            <li class="{if $conpage_title=='keep_the_house'}active{else}noactive{/if}"><a title="Прочие" href="?page=content_page&title=other_service">Прочие</a></li>
        ...
        {/if}
        {if $spage=='house'}
            <li class="{if $category=='all'}active{else}noactive{/if}"><a title="Обслуживаемые дома" href="?page=content_page&title=vashdom">Обслуживаемые дома</a></li>
        ...
        {/if}
        {if $spage=='reports'}
            <li class="{if $conpage_title=='financial_statements'}active{else}noactive{/if}"><a title="План расходов" href="?page=content_page&title=vashdom">План расходов</a></li>
            <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Отчёт по расходам" href="?page=content_page&title=vashdom">Отчёт по расходам</a></li>
            <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Отчёт по затратам" href="?page=content_page&title=vashdom">Отчёт по затратам</a></li>
        {/if}
    </ul>
