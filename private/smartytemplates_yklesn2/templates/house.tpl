...
{foreach from=$street.houses item=house}
                    <tr>
                        <td class="pim" align="center" style="border:#008630 solid 1px;">{$house.number}{$house.subnumber}</td>
                        <td class="pim" align="center" style="border:#008630 solid 1px;">{$house.area}</td>
