...
$__cfg['db.dsn'] = 'mysql://sibdnevnik_sbor2:e10adc39h@localhost:3306/sibdnevnik_sbor2';
...
$__cfg['smarty.templates'] = $__cfg['site.main.dir'] . 'private/smartytemplates_sbor2/templates/';
$__cfg['smarty.compile']   = $__cfg['site.main.dir'] . 'private/smartytemplates_sbor2/templates_c/';
$__cfg['smarty.cache']     = $__cfg['site.main.dir'] . 'private/smartytemplates_sbor2/cache/';
$__cfg['smarty.compile_check'] = true;
$__cfg['smarty.debug'] = false;

$__cfg['smarty.default.title'] = 'ООО «Управляющая компания Серебряный бор».';
...
$__cfg['site.url'] = 'http://ооо-серебряныйбор.рф/';
