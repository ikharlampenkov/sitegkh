...
$__cfg['db.dsn'] = 'mysql://sibdnevnik_shalg:e10adc39h@localhost:3306/sibdnevnik_shalg';
...
$__cfg['smarty.templates'] = $__cfg['site.main.dir'] . 'private/smartytemplates_shalgo/templates/';
$__cfg['smarty.compile']   = $__cfg['site.main.dir'] . 'private/smartytemplates_shalgo/templates_c/';
$__cfg['smarty.cache']     = $__cfg['site.main.dir'] . 'private/smartytemplates_shalgo/cache/';
$__cfg['smarty.compile_check'] = true;
$__cfg['smarty.debug'] = false;

$__cfg['smarty.default.title'] = 'ООО «Управляющая компания Шалготарьян».';
...
$__cfg['site.url'] = 'http://шалготарьян.рф/';
