...
$__cfg['db.dsn'] = 'mysql://sibdnevnik_przvd:e10adc39h@localhost:3306/sibdnevnik_przvd';
...
$__cfg['smarty.templates'] = $__cfg['site.main.dir'] . 'private/smartytemplates_przvd/templates/';
$__cfg['smarty.compile']   = $__cfg['site.main.dir'] . 'private/smartytemplates_przvd/templates_c/';
$__cfg['smarty.cache']     = $__cfg['site.main.dir'] . 'private/smartytemplates_przvd/cache/';
$__cfg['smarty.compile_check'] = true;
$__cfg['smarty.debug'] = false;

$__cfg['smarty.default.title'] = 'ООО «Управляющая компания Предзаводская».';
...
$__cfg['site.url'] = 'http://ук-предзаводская.рф/';
