...
$__cfg['db.dsn'] = 'mysql://sibdnevnik_plus:e10adc39h@localhost:3306/sibdnevnik_plus';
...
$__cfg['smarty.templates'] = $__cfg['site.main.dir'] . 'private/smartytemplates_plus/templates/';
$__cfg['smarty.compile']   = $__cfg['site.main.dir'] . 'private/smartytemplates_plus/templates_c/';
$__cfg['smarty.cache']     = $__cfg['site.main.dir'] . 'private/smartytemplates_plus/cache/';
$__cfg['smarty.compile_check'] = true;
$__cfg['smarty.debug'] = false;

$__cfg['smarty.default.title'] = 'ООО «Управляющая компания Плюс».';
...
$__cfg['site.url'] = 'http://ук-плюс.рф/';
