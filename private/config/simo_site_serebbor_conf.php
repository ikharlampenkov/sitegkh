...
$__cfg['db.dsn'] = 'mysql://dnevnik_gkxuser:e10adc39h@db.hosting.risp.ru:3606/dnevnik_gkh_serebbor';
...
$__cfg['smarty.templates'] = $__cfg['site.main.dir'] . 'private/smartytemplates_sbor/templates/';
$__cfg['smarty.compile']   = $__cfg['site.main.dir'] . 'private/smartytemplates_sbor/templates_c/';
$__cfg['smarty.cache']     = $__cfg['site.main.dir'] . 'private/smartytemplates_sbor/cache/';
$__cfg['smarty.compile_check'] = true;
$__cfg['smarty.debug'] = false;

$__cfg['smarty.default.title'] = 'ООО "Cеребряный Бор.рф"';
...
$__cfg['site.url'] = 'http://ук-серебряныйбор.рф/';
