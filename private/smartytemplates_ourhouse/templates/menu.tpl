<div class="panel">
        ...
        <tr>
            ...
            <td width="553">
                <ul>
                    ...
                    <li class="{if $spage=='about'}active{else}noactive{/if}"><a id="tmC" title="О нас" href="?page=content_page&title=about">О нас</a></li>
                    ...
                    <li class="{if $spage=='reports'}active{else}noactive{/if}"><a id="tmO" title="Отчеты" href="?page=content_page&title=reports">Отчеты</a></li>
                </ul>
            </td>
    ...
    <ul class="sub">
        ...
        {if $spage=='about'}
            ...
            <li class="{if $page=='license'}active{else}noactive{/if}"><a title="О нас" href="?page=license&spage=about">О нас</a></li>
        ...
        {/if}
        {if $spage=='reports'}
            <li class="{if $conpage_title=='financial_statements'}active{else}noactive{/if}"><a title="Книга доходов и расходов" href="?page=content_page&title=book">Книга доходов и расходов</a></li>
            <li class="{if $conpage_title=='financial_statements'}active{else}noactive{/if}"><a title="Фин. отчёт 2010" href="?page=content_page&title=ot.2010">Фин. отчёт 2010</a></li>
            <li class="{if $conpage_title=='income'}active{else}noactive{/if}"><a title="Фин. отчёт 2011" href="?page=content_page&title=ot.2011">Фин. отчёт 2011</a></li>
        {/if}
    </ul>
