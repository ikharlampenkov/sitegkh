<div class="panel">
    ...
    <ul class="sub">
        ...
        {/if}
        {if $spage=='service'}
            <li class="{if $conpage_title=='eltechrab'}active{else}noactive{/if}"><a title="Электротехнические работы" href="?page=content_page&action=edit&id=eltechrab&spage=service">Электротехнические</a></li>
            <li class="{if $conpage_title=='santechrab'}active{else}noactive{/if}"><a title="Сантехнические работы" href="?page=content_page&action=edit&id=santechrab&spage=service">Сантехнические</a></li>
            {*<li class="{if $conpage_title=='keep_the_house'}active{else}noactive{/if}"><a title="Плотничные, столярные и стекольные работы" href="?page=content_page&action=edit&id=prochie_rab&spage=service">Плотничные, столярные и стекольные</a></li>*}
...
<script type="text/javascript">
    ...
    { id:"tmS",subs:[ { "t":"Электротехнические","u":"?page=content_page&action=edit&id=eltechrab&spage=service" } , { "t":"Сантехнические","u":"?page=content_page&action=edit&id=santechrab&spage=service" } , { "t":"Где оплатить?","u":"?page=content_page&action=edit&id=where_to_pay&spage=service" } ] } ,
    ...
    { id:"tma",subs:[ { "t":"Обслуживаемые дома","u":"?page=content_page&action=edit&id=house&spage=house" } , { "t":"План проводимых работ","u":"?page=content_page&action=edit&id=plan_prov_rabot&spage=house" } ] } ,
